...
Приложение для упрощения повседневной рутины, в части работы с файлами и папками. Расширение функционала производится подключаемыми модулями.

[История изменений](./_devlog/_log_of_changes.md)
